...
// For example, below, we use https://etherscan.io/ to view transactions on the Mumbai testnet.
export const ETHERSCAN_URL = "https://etherscan.io/";

// 5. Alchemy Network URL for NFT Endpoint
export const ALCH_NET = "eth-mainnet"

// 6. Your Branding
export const FOOTER_LOGO = "/zerobeings_logo_m.png"
export const NAV_LOGO = "/logo.png"
