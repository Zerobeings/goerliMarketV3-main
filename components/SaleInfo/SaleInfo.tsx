...
export default function SaleInfo({ nft, collection }: Props) {
  ...
  const { contract: nftCollection } = useContract(NFT_COLLECTION_ADDRESS, abi); //may need to rethink this for any collection - to be tested
        ...
        >
          ...
          <Web3Button
            ...
            onSuccess={(txResult) => {
              ...
              router.push(
                `/token/${NFT_COLLECTION_ADDRESS}/${IDtoken}`
              );
            }}
          >
